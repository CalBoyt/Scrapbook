...
namespace Scrapbook.Utils
{
    public static class DbUtils
    {
        ...
        //public static bool IsOne(SqlDataReader reader, string column)
        //{
        //    return reader.IsOne(reader.GetOrdinal(column));
        //}
